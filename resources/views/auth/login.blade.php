@extends('Admin_layouts.Home_master_layout')
@section('content')

    <div class="auth-layout-wrap" style="background-image: url({{asset('Admin_asset/dist-assets/images/photo-wide-4.jpg')}})">
        <div class="auth-content">
            <div class="card o-hidden">
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-4">
                            <div class="auth-logo text-center mb-4"><img src="{{asset('Admin_asset/dist-assets/images/logo.png')}}" alt=""></div>
