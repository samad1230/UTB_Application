        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title mb-3">Product Add</div>
                            <form action="{{route('Product.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4 form-group mb-3">
                                        <label for="firstName2">Product name</label>
                                        <input class="form-control form-control-rounded" id="product_name" name="productname" type="text" placeholder="Product name" />
                                    </div>
                                    <div class="col-md-4 form-group mb-3">
                                        <label for="lastName2">Product Details</label>
                                        <textarea class="form-control" name="productdetails" aria-label="With textarea" placeholder="Product Details"></textarea>
                                    </div>

                                    <div class="col-md-4 form-group mb-3">
                                        <label for="picker1">Category</label>
                                        <select class="form-control form-control-rounded js-example-basic-multiple" name="category_ids[]" multiple="multiple">
                                    ...
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        <select class="form-control form-control-rounded js-example-basic-multiple" name="subcategory_ids[]" multiple="multiple">
                                    ...
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        <select class="form-control form-control-rounded" name="brandid" id="brand_id">
                                    ...
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        <input type="number" class="form-control form-control-rounded" name="warranty" id="warranty" placeholder="12 Month" />
                                    </div>
                                    <div class="col-md-4 form-group mb-3">
                                    ...
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-rounded" name="stokestatus" id="" placeholder="Stoke Status" />
                                    </div>
                                    <div class="col-md-4 form-group mb-3 field_wrapper">
                                        <label for="credit2">Feature Products</label>
                                        <div class="appendbody">
                                            <input type="text"  class="form-control form-control-rounded appendform" name="feature_products[]" value="" placeholder="Feature"/>
                                            <a href="javascript:void(0);" class="add_button" title="Add field"><img src="{{asset('Media/image/add-icon.png')}}" alt="image"/></a>
                                        </div>
                                    </div>

                                    <div class="col-md-4 form-group mb-3 field_wrappergroup">
                                        <label for="credit2">Product Group</label>
                                        <div class="appendbody">
                                            <input type="text"  class="form-control form-control-rounded appendform" name="products_group[]" value="" placeholder="Group Name"/>
