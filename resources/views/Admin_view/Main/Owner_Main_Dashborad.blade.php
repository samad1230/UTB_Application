@extends('Admin_layouts.Owner_master_layout')
@section('content')
                        ...
                        <div data-sidebar-content="secondary">
                            <div class="inbox-secondary-sidebar-content position-relative" style="min-height: 500px">
                                <div class="inbox-details perfect-scrollbar rtl-ps-none" data-suppress-scroll-x="true" style="padding: 1.5rem 5rem;">
                                    <button class="btn btn-rounded btn-primary btn-block mb-4">Admin Registration Form</button>
                                    <form action="{{route('admin.registration')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        <div class="secendform">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <label class="user_name" for="">User Name :</label>
                                                </div>
                                                <div class="col-md-7">
