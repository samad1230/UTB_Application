    ...
    <div class="side-content-wrap">
        <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
            <ul class="navigation-left">
                ...
                <li class="nav-item" data-item="productmenu"><a class="nav-item-hold" href="#"><i class="nav-icon i-Suitcase"></i><span class="nav-text">Hr Menu </span></a>
                    <div class="triangle"></div>
                </li>
        ...
        <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
            ...
            <ul class="childNav" data-parent="productmenu">
                <li class="nav-item"><a href=""><i class="nav-icon i-Add"></i><span class="item-name">Add Hr</span></a></li>
